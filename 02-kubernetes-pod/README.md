...
As mentioned, there are other multi container patterns for pods. [This blog post](https://medium.com/bb-tutorials-and-thoughts/kubernetes-learn-sidecar-container-pattern-6d8c21f873d) talks about the other most popular one which is the sidecar pattern. It also has links to blogs about the others as well
